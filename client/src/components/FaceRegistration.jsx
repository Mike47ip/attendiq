      ...
      <div className="w-full max-w-sm flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 flex flex-col gap-3">
              {[
                ...
                { icon: "🔒", text: "Verified by Microsoft Azure AI" },
              ].map(({ icon, text }) => (
        ...
        {(step === "camera" || step === "capturing") && (
          <div className="flex flex-col gap-4">
            ...
            <button onClick={captureAndUpload} disabled={step === "capturing"}
            ...
            <button onClick={() => { stopCamera(); setStep("intro"); setError(null); }}
        ...
        {step === "uploading" && (
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 text-center flex flex-col gap-3">
            ...
            <div className="text-zinc-300 text-sm font-semibold">Registering with Azure AI…</div>
